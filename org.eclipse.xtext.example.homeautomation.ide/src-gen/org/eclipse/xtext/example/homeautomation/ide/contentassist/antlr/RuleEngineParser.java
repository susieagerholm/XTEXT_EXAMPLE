...
public class RuleEngineParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalRuleEngineParser createParser() {
		InternalRuleEngineParser result = new InternalRuleEngineParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeviceAccess().getGroup_4_1(), "rule__Device__Group_4_1__0");
					...
					put(grammarAccess.getDeviceAccess().getStatesAssignment_4_0(), "rule__Device__StatesAssignment_4_0");
					put(grammarAccess.getDeviceAccess().getStatesAssignment_4_1_1(), "rule__Device__StatesAssignment_4_1_1");
					...
					put(grammarAccess.getRuleAccess().getDeviceStateAssignment_3(), "rule__Rule__DeviceStateAssignment_3");
					put(grammarAccess.getRuleAccess().getThenPartAssignment_5(), "rule__Rule__ThenPartAssignment_5");
