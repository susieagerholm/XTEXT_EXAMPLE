 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydot.myDot.impl.ReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends FeatureImpl implements Reference
{
  ...
  {
    return MyDotPackage.Literals.REFERENCE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDotPackage.REFERENCE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Entity newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDotPackage.REFERENCE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDotPackage.REFERENCE__TYPE:
